...
NSE_TICKERS = [
    ...
    'BHARTIARTL.NS', 'HINDUNILVR.NS', 'MARUTI.NS', 'HCLTECH.NS',
    'WIPRO.NS', 'BAJAJFINSV.NS', 'BAJFINANCE.NS', 'DRREDDY.NS',
    'SUNPHARMA.NS', 'ULTRACEMCO.NS', 'EICHERMOT.NS', 'ONGC.NS',
    'POWERGRID.NS', 'JSWSTEEL.NS', 'TECHM.NS', 'TATAMOTORS.NS',
    'TATASTEEL.NS', 'GRASIM.NS', 'HEROONGO.NS', 'ADANIENT.NS',
    'ADANIPORTS.NS', 'JIOFIN.NS', 'INDUSINDBK.NS', 'TITAN.NS',
    'TRENT.NS', 'NTPC.NS', 'BRITANNIA.NS', 'ONGC.NS', 'BPCL.NS',
    'CIPLA.NS', 'COALINDIA.NS', 'BPCL.NS', 'GAIL.NS', 'SBILIFE.NS',
    'SHCERAMICS.NS', 'TORNTPHARM.NS', 'AMBUJACEM.NS', 'M&M.NS',
    'LUPIN.NS', 'NESTLEIND.NS'
]
