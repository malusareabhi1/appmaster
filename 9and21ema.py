...
nifty_100_stocks = [
    'ADANIENT.NS', 'ADANIGREEN.NS', 'ADANIPORTS.NS', 'ADANIPOWER.NS', 'ADANITRANS.NS',
    ...
    'BRITANNIA.NS', 'CIPLA.NS', 'COALINDIA.NS', 'COLPAL.NS', 'DABUR.NS',
    'DIVISLAB.NS', 'DLF.NS', 'DRREDDY.NS', 'EICHERMOT.NS', 'GAIL.NS',
    'GODREJCP.NS', 'GRASIM.NS', 'HAVELLS.NS', 'HCLTECH.NS', 'HDFC.NS',
    'HDFCBANK.NS', 'HDFCLIFE.NS', 'HEROMOTOCO.NS', 'HINDALCO.NS', 'HINDPETRO.NS',
    'HINDUNILVR.NS', 'ICICIBANK.NS', 'IDFCFIRSTB.NS', 'IGL.NS', 'INDIGO.NS',
    'INDUSINDBK.NS', 'INFY.NS', 'IOC.NS', 'ITC.NS', 'JINDALSTEL.NS',
    'JSWSTEEL.NS', 'KOTAKBANK.NS', 'LICI.NS', 'LT.NS', 'LTI.NS',
    'LTTS.NS', 'M&M.NS', 'MARICO.NS', 'MARUTI.NS', 'MCDOWELL-N.NS',
    'MOTHERSON.NS', 'MPHASIS.NS', 'MRF.NS', 'NESTLEIND.NS', 'NMDC.NS',
    'NTPC.NS', 'OBEROIRLTY.NS', 'ONGC.NS', 'PEL.NS', 'PETRONET.NS',
    'PIIND.NS', 'PIDILITIND.NS', 'PNB.NS', 'POWERGRID.NS', 'RECLTD.NS',
    'RELIANCE.NS', 'SAIL.NS', 'SBILIFE.NS', 'SBIN.NS', 'SHREECEM.NS',
    'SIEMENS.NS', 'SRF.NS', 'SUNPHARMA.NS', 'TATACHEM.NS', 'TATACONSUM.NS',
    'TATAMOTORS.NS', 'TATASTEEL.NS', 'TCS.NS', 'TECHM.NS', 'TITAN.NS',
    'TORNTPHARM.NS', 'TRENT.NS', 'TVSMOTOR.NS', 'ULTRACEMCO.NS', 'UPL.NS',
